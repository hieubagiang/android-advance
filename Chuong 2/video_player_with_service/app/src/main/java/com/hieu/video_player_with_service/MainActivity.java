...
public class MainActivity extends AppCompatActivity {
    ...
    private Button buttonSelectLocal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.buttonSelectLocal = (Button) this.findViewById(R.id.button_select_local);
        ...
        }); this.buttonSelectLocal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Select new media source.
                selectLocalMediaSource();
            }
        });
...
//        this.selectRawMediaSource();
    ...
    private void selectLocalMediaSource()  {
        ...
        String localPath = Utils.getFilePath("test2.mp4");
        MediaPlayerUtils.playLocalMedia(this, this.mediaPlayer, MediaPlayerUtils.LOCAL_MEDIA_SAMPLE);
    }
